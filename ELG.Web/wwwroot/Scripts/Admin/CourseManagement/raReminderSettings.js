$(function () {
    ...
    UTILS.activateMenuNavigationLink('menu-set-ra-reminder');
    $('[data-toggle="tooltip"]').tooltip();
    raRemiderHandler.init();
})

var raRemiderHandler = (function () {
    ...
    $updateBtn.click(function (e) {
        ...
        if (confirm("Are you sure you want to update reminder settings?")) {
            ...
            $.ajax({
                type: 'post',
                url: hdnBaseUrl + "Home/UpdateRAReminder",
                dataType: 'json',
                data: configuration,
    ...
    function init() {
        $.ajax({
            type: 'post',
            url: hdnBaseUrl + "home/LoadRAReminderData",
            dataType: 'json',
